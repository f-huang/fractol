...
static void		transform_flags(t_printf *link, char *str, int len, bool neg)
{
	static void	(*p[5])(t_printf *link, char *str, int len, bool neg);
	int			i;
...
static void		get_neg(t_printf *link, bool *neg)
{
	*neg = false;
...
static int		get_len(t_printf *link, char *ret, bool neg)
{
	int			len;
...
static void		get_right_itoa(t_printf *link, char **ret, int base, bool *neg)
{
